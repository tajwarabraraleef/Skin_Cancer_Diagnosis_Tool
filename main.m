...
setpref('Internet','E_mail','skindiagnosissystem@gmail.com');
setpref('Internet','SMTP_Username','skindiagnosissystem');
setpref('Internet','SMTP_Password','vicorob2017');
...
str = "Dear " + string(patients(handles.patientidx,5)) + ","+ newline + newline + "Your patient,"+ string(patients(handles.patientidx,1))  +", has just taken a Skin Diagnosis test. The results and the image is attached below:" + newline + newline + "Result: " + handles.res + newline + newline + "Thank you";
